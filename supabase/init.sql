...
DROP TABLE IF EXISTS public.ad_location_bookings;
DROP TABLE IF EXISTS public.ad_locations;
...
-- Create indexes
CREATE INDEX idx_ad_location_bookings_location_id 
    ON public.ad_location_bookings(location_id);
CREATE INDEX idx_ad_location_bookings_advertiser_id 
    ON public.ad_location_bookings(advertiser_id);
CREATE INDEX idx_ad_location_bookings_status 
    ON public.ad_location_bookings(status);
CREATE INDEX idx_ad_location_bookings_dates 
